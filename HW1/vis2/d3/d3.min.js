...
!function(t, n) {
    ...
    function p(t, n, e) {
        var r = Math.abs(n - t) / Math.max(0, e)
          ...
          , o = r / i;
        return o >= Rd ? i *= 10 : o >= Ud ? i *= 5 : o >= Dd && (i *= 2),
        n < t ? -i : i
    }
    function d(t) {
    ...
    function v() {
        ...
        t.thresholds = function(n) {
            return arguments.length ? (r = "function" == typeof n ? n : s(Array.isArray(n) ? qd.call(n) : n),
            t) : r
        }
        ,
        t
        ...
        function t() {
            ...
            l > mv)
                if (d > wv - mv)
                    ...
                    c.arc(0, 0, l, h, p, !v),
                    f > mv && (c.moveTo(f * Math.cos(p), f * Math.sin(p)),
                    c.arc(0, 0, f, p, h, v));
                else {
                    ...
                    M > mv ? A > mv ? (_ = cn(D, O, z, P, l, A, v),
                    y = cn(R, U, q, L, l, A, v),
                    c.moveTo(_.cx + _.x01, _.cy + _.y01),
                    A < S ? c.arc(_.cx, _.cy, A, Math.atan2(_.y01, _.x01), Math.atan2(y.y01, y.x01), !v) : (c.arc(_.cx, _.cy, A, Math.atan2(_.y01, _.x01), Math.atan2(_.y11, _.x11), !v),
                    ...
                    f > mv && w > mv ? N > mv ? (_ = cn(q, L, R, U, f, -N, v),
                    y = cn(z, P, D, O, f, -N, v),
                    c.lineTo(_.cx + _.x01, _.cy + _.y01),
                    N < S ? c.arc(_.cx, _.cy, N, Math.atan2(_.y01, _.x01), Math.atan2(y.y01, y.x01), !v) : (c.arc(_.cx, _.cy, N, Math.atan2(_.y01, _.x01), Math.atan2(_.y11, _.x11), !v),
                    c.arc(0, 0, f, Math.atan2(_.cy + _.y11, _.cx + _.x11), Math.atan2(y.cy + y.y11, y.cx + y.x11), v),
                    c.arc(y.cx, y.cy, N, Math.atan2(y.y11, y.x11), Math.atan2(y.y01, y.x01), !v))) : c.arc(0, 0, f, b, x, v) : c.lineTo(q, L)
                }
            else
                c.moveTo(0, 0);
            if (c.closePath(),
    ...
    function se() {
        ...
        return t.keys = function(e) {
            return arguments.length ? (n = "function" == typeof e ? e : Kt(Gv.call(e)),
            t) : n
        }
        ,
        t.value = function(n) {
        ...
        ,
        t.order = function(n) {
            return arguments.length ? (e = null == n ? ae : "function" == typeof n ? n : Kt(Gv.call(n)),
            t) : e
        }
        ,
        t.offset = function(n) {
    ...
    function Te(t) {
        ...
        t ? (t = t.rgb(),
        new Se(t.r,t.g,t.b,t.opacity)) : new Se
    }
    function ke(t, n, e, r) {
    ...
    function cr(t, n) {
        ...
        C_) : ar : n instanceof be ? C_ : n instanceof Date ? er : Array.isArray(n) ? nr : isNaN(n) ? ir : rr)(t, n)
    }
    function sr(t, n) {
        return t = +t,
        n -= t,
    ...
    function lr(t) {
        return "none" === t ? U_ : (S_ || (S_ = document.createElement("DIV"),
        N_ = document.documentElement,
        A_ = document.defaultView),
        S_.style.transform = t,
        t = A_.getComputedStyle(N_.appendChild(S_), null ).getPropertyValue("transform"),
        N_.removeChild(S_),
        t = t.slice(7, -1).split(","),
        fr(+t[0], +t[1], +t[2], +t[3], +t[4], +t[5]))
    }
    function hr(t) {
        return null == t ? U_ : (E_ || (E_ = document.createElementNS("http://www.w3.org/2000/svg", "g")),
        E_.setAttribute("transform", t),
        (t = E_.transform.baseVal.consolidate()) ? (t = t.matrix,
        fr(t.a, t.b, t.c, t.d, t.e, t.f)) : U_)
    }
    function pr(t, n, e, r) {
        function i(t) {
    ...
    function Br() {
        ...
        ++dy;
        for (var t, n = G_; n; )
            (t = my - n._time) >= 0 && n._call.call(null , t),
            n = n._next;
        --dy
    }
    function jr(t) {
    ...
    function Vr(t) {
        if (!dy) {
            ...
            var n = t - my;
            n > 24 ? (t < 1 / 0 && (vy = setTimeout(jr, n)),
            _y && (_y = clearInterval(_y))) : (_y || (_y = setInterval(Hr, yy)),
            dy = 1,
            wy(jr))
        }
    }
        ...
        function n(t, n) {
            return function(e) {
                ...
                for (e instanceof Date || (e = new Date(+e)); ++a < s; )
                    ...
                    null != (i = Lg[r = t.charAt(++a)]) ? r = t.charAt(++a) : i = "e" === r ? " " : "0",
                    (o = n[r]) && (r = o(e, i)),
                    u.push(r),
                    c = a + 1);
    ...
    function ho(t) {
        ...
        ,
        n.range = function(e) {
            return arguments.length ? (t = jg.call(e),
            n) : t.slice()
        }
        ,
    ...
    function ko(t, n) {
        ...
        ,
        r.domain = function(t) {
            return arguments.length ? (a = Bg.call(t, go),
            e()) : a.slice()
        }
        ,
        r.range = function(t) {
            return arguments.length ? (c = jg.call(t),
            e()) : c.slice()
        }
        ,
    ...
    function Eo() {
        ...
        t.domain = t.range = function(e) {
            return arguments.length ? (n = Bg.call(e, go),
            t) : n.slice()
        }
        ,
        t.copy = function() {
    ...
    function Yo() {
        ...
        ,
        e.range = function(n) {
            return arguments.length ? (i = jg.call(n),
            t()) : i.slice()
        }
        ,
    ...
    function Bo() {
        ...
        ,
        t.range = function(t) {
            return arguments.length ? (i = (u = jg.call(t)).length - 1,
            n()) : u.slice()
        }
        ,
    ...
    function jo() {
        ...
        return t.domain = function(i) {
            return arguments.length ? (n = jg.call(i),
            r = Math.min(n.length, e.length - 1),
            t) : n.slice()
        }
        ,
        t.range = function(i) {
            return arguments.length ? (e = jg.call(i),
            r = Math.min(n.length, e.length - 1),
            t) : e.slice()
        }
        ,
    ...
    function Nu(t, n, e, r, i, o, u) {
        ...
        for (a = 0; a < l; ++a)
            (c = n[a]) && (p[a] = s = xm + u.call(c, c.__data__, a, n),
            s in f ? i[a] = c : f[s] = c);
        for (a = 0; a < h; ++a)
    ...
    function Ia(t, n) {
        ...
        if (!e || !(e = e[n]) || e.state > Tm)
            throw new Error("too late");
        return e
    }
    function Ya(t, n) {
        var e = t.__transition;
        if (!e || !(e = e[n]) || e.state > Sm)
            throw new Error("too late");
        return e
    }
    function Ba(t, n) {
    ...
    function ja(t, n, e) {
        ...
        function i(r) {
            ...
            for (i in a)
                f = a[i],
                f.name === e.name && (f.state === Nm ? (f.state = Em,
                f.timer.stop(),
                f.on.call("interrupt", t, t.__data__, f.index, f.group),
                delete a[i]) : +i < n && (f.state = Em,
                f.timer.stop(),
                delete a[i]));
            if (Wr(function() {
                e.state === Nm && (e.timer.restart(o, e.delay, e.time),
                o(r))
            }),
            e.state = Sm,
        ...
        function o(r) {
            for (var i = r < e.duration ? e.ease.call(null , r / e.duration) : (e.state = Am,
    ...
    function Ga(t, n) {
        var e;
        return ("number" == typeof n ? rr : n instanceof be ? C_ : (e = be(n)) ? (n = e,
        C_) : ar)(t, n)
    }
    function Ja(t) {
        return function() {
    ...
    function Wc(t, n) {
        function e(e) {
            var s, f = null == i ? n.ticks ? n.ticks.apply(n, r) : n.domain() : i, l = null == o ? n.tickFormat ? n.tickFormat.apply(n, r) : Bc : o, h = Math.max(u, 0) + c, p = t === Um || t === Om ? jc : Hc, d = n.range(), v = d[0] + .5, _ = d[d.length - 1] + .5, y = (n.bandwidth ? Xc : Bc)(n.copy()), g = e.selection ? e.selection() : e, m = g.selectAll(".domain").data([null ]), x = g.selectAll(".tick").data(f, n).order(), b = x.exit(), w = x.enter().append("g").attr("class", "tick"), M = x.select("line"), T = x.select("text"), k = t === Um || t === Fm ? -1 : 1, S = t === Fm || t === Dm ? (s = "x",
            "y") : (s = "y",
            "x");
            m = m.merge(m.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "#000")),
            x = x.merge(w),
            M = M.merge(w.append("line").attr("stroke", "#000").attr(s + "2", k * u).attr(S + "1", .5).attr(S + "2", .5)),
            T = T.merge(w.append("text").attr("fill", "#000").attr(s, k * h).attr(S, .5).attr("dy", t === Um ? "0em" : t === Om ? "0.71em" : "0.32em")),
            e !== g && (m = m.transition(e),
            x = x.transition(e),
            M = M.transition(e),
            T = T.transition(e),
            b = b.transition(e).attr("opacity", Im).attr("transform", function(t) {
            ...
            b.remove(),
            m.attr("d", t === Fm || t == Dm ? "M" + k * a + "," + v + "H0.5V" + _ + "H" + k * a : "M" + v + "," + k * a + "V0.5H" + _ + "V" + k * a),
            x.attr("opacity", 1).attr("transform", function(t) {
                return p(y, y, t)
            }),
            M.attr(s + "2", k * u),
            T.attr(s, k * h).text(l),
            g.filter(Vc).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", t === Dm ? "start" : t === Fm ? "end" : "middle"),
            g.each(function() {
                this.__axis = y
            })
        }
        ...
        ,
        e.ticks = function() {
            return r = Rm.call(arguments),
            e
        }
        ,
        e.tickArguments = function(t) {
            return arguments.length ? (r = null == t ? [] : Rm.call(t),
            e) : r.slice()
        }
        ,
        e.tickValues = function(t) {
            return arguments.length ? (i = null == t ? null : Rm.call(t),
            e) : i && i.slice()
        }
        ,
    ...
    function Uf() {
        ...
        function o() {
            if (l.apply(this, arguments)) {
                ...
                for (n = 0; n < o; ++n)
                    (e = c(r[n].identifier, i, Da, this, arguments)) && (Nf(),
                    e("start"))
            }
        }
        function u() {
    ...
    function Gf(t, n, e, r) {
        for (var i, o = Km.length; o--; )
            Zf(i = Km[o], t, n, e, r) && $f(i, t, n, e, r) && (Math.abs(i[0][0] - i[1][0]) > ex || Math.abs(i[0][1] - i[1][1]) > ex) || delete Km[o]
    }
    function Jf(t) {
        return Jm[t.index] = {
            site: t,
        ...
        for (i = 0; i < _; ++i)
            if (o = Jm[i]) {
                ...
                s = c.length; a < s; )
                    ...
                    l = f[0],
                    h = f[1],
                    (Math.abs(d - l) > ex || Math.abs(v - h) > ex) && (c.splice(a, 0, Km.push(Vf(u, p, Math.abs(d - t) < ex && r - v > ex ? [t, Math.abs(l - t) < ex ? h : r] : Math.abs(v - r) < ex && e - d > ex ? [Math.abs(h - r) < ex ? l : e, r] : Math.abs(d - e) < ex && v - n > ex ? [e, Math.abs(l - e) < ex ? h : n] : Math.abs(v - n) < ex && d - t > ex ? [Math.abs(h - n) < ex ? l : t, n] : null )) - 1),
                    ++s);
                s && (y = !1)
            }
        if (y) {
    ...
    function sl(t) {
        var n = t.circle
          ...
          , a = [t];
        cl(t);
        for (var c = o; c.circle && Math.abs(e - c.circle.x) < ex && Math.abs(r - c.circle.cy) < ex; )
            o = c.P,
            a.unshift(c),
            cl(c),
            c = o;
        a.unshift(c),
        ol(c);
        for (var s = u; s.circle && Math.abs(e - s.circle.x) < ex && Math.abs(r - s.circle.cy) < ex; )
            u = s.N,
            a.push(s),
            cl(s),
            s = u;
    ...
    function Il(n) {
        ...
        function u() {
            ...
            function o() {
                ...
                case ux:
                case ox:
                    N && (m = Math.max(P - l, Math.min(L - v, m)),
                    h = l + m,
                    _ = v + m),
                    ...
                    break;
                case ax:
                    N < 0 ? (m = Math.max(P - l, Math.min(L - l, m)),
                    h = l + m,
                    _ = v) : N > 0 && (m = Math.max(P - v, Math.min(L - v, m)),
                    h = l,
                    _ = v + m),
                    ...
                    break;
                case cx:
                    N && (h = Math.max(P, Math.min(L, l - m * N)),
            ...
            function s() {
                ...
                case 16:
                    ...
                    break;
                case 18:
                    S === cx && (N < 0 ? v = _ : N > 0 && (l = h),
                    A < 0 ? y = g : A > 0 && (p = d),
                    S = ax,
                    o());
                    break;
                case 32:
                    S === ux && (t.event.altKey ? (N && (v = _ - m * N,
                    l = h + m * N),
                    A && (y = g - x * A,
                    p = d + x * A),
                    S = cx) : (N < 0 ? v = _ : N > 0 && (l = h),
            ...
            if (f.apply(this, arguments)) {
                ...
                "overlay" === k ? E.selection = z = [[l = n === fx ? P : D[0], p = n === sx ? q : D[1]], [v = n === fx ? L : l, y = n === sx ? R : p]] : (l = z[0][0],
                p = z[0][1],
                v = z[1][0],
                y = z[1][1]),
                h = l,
        ...
        e.extent = function(t) {
            return arguments.length ? (s = "function" == typeof t ? t : Nl([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]),
            e) : s
        }
        ,
        e.filter = function(t) {
            return arguments.length ? (f = "function" == typeof t ? t : Nl(!!t),
            e) : f
        }
        ,
    ...
    function Bl() {
        ...
        return t.padAngle = function(e) {
            return arguments.length ? (n = wx(0, e),
            t) : n
        }
        ,
    ...
    function Zl() {
        function t() {
            var t, a = Mx.call(arguments), c = n.apply(this, a), s = e.apply(this, a), f = +r.apply(this, (a[0] = c,
            a)), l = i.apply(this, a) - xx, h = o.apply(this, a) - xx, p = f * yx(l), d = f * gx(l), v = +r.apply(this, (a[0] = s,
            a)), _ = i.apply(this, a) - xx, y = o.apply(this, a) - xx;
            if (u || (u = t = Tt()),
            u.moveTo(p, d),
            u.arc(0, 0, f, l, h),
            l === _ && h === y || (u.quadraticCurveTo(0, 0, v * yx(_), v * gx(_)),
            u.arc(0, 0, v, _, y)),
    ...
    function xh(t, n) {
        ...
        if (Ux) {
            ...
            f ^ (c * qx < s && s < c * t) ? (u = o[1] * cb,
            u > Px && (Px = u)) : (s = (s + 360) % 360 - 180,
            f ^ (c * qx < s && s < c * t) ? (u = -o[1] * cb,
            u < Cx && (Cx = u)) : (n < Cx && (Cx = n),
            n > Px && (Px = n))),
            f ? t < qx ? Sh(Ex, t) > Sh(Ex, zx) && (zx = t) : Sh(t, zx) > Sh(Ex, zx) && (Ex = t) : zx >= Ex ? (t < Ex && (Ex = t),
            t > zx && (zx = t)) : t > qx ? Sh(Ex, t) > Sh(Ex, zx) && (zx = t) : Sh(t, zx) > Sh(Ex, zx) && (Ex = t)
        } else
            mh(t, n);
        Ux = e,
        qx = t
    ...
    function Eh(t) {
        ...
        e = Dx.length) {
            ...
            o = [r]; n < e; ++n)
                i = Dx[n],
                Ah(r, i[0]) || Ah(r, i[1]) ? (Sh(r[0], i[1]) > Sh(r[0], r[1]) && (r[1] = i[1]),
                Sh(i[0], r[1]) > Sh(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
            for (u = -(1 / 0),
            e = o.length - 1,
            n = 0,
            r = o[e]; n <= e; r = i,
        ...
        return Dx = Ox = null ,
        Ex === 1 / 0 || Cx === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[Ex, Cx], [zx, Px]]
    }
    function Ch(t, n) {
        t *= sb,
        n *= sb;
            ...
            if (f = (s = t[a]).length)
                ...
                l = y) {
                    var y = s[_]
                      ...
                      , k = T > ib
                      , S = d * x;
                    if (lw.add(hb(S * M * gb(T), v * b + S * pb(T))),
                    o += k ? w + M * ab : w,
                    k ^ h >= e ^ g >= e) {
                        var N = vh(ph(l), ph(y));
                        gh(N);
    ...
    function Bp(t, n) {
        ...
        function o(t, n, e) {
            ...
            if (!(m < 0)) {
                ...
                k = S,
                S = w),
                E ? A ? k + S > 0 ^ b[1] < (fb(b[0] - M) < eb ? k : S) : k <= b[1] && b[1] <= S : N > ib ^ (M <= b[0] && b[0] <= T)) {
                    var C = yh(_, (-y + x) / g);
                    return _h(C, d),
                    [b, hh(C)]
                }
    ...
    function Jp(t, n) {
        function e(r, i, o, u, a, c, s, f, l, h, p, d, v, _) {
            ...
            if (m > 4 * n && v--) {
                var x = u + h
                  ...
                  , C = A - i
                  , z = g * E - y * C;
                (z * z / m > n || fb((y * E + g * C) / m - .5) > .3 || u * h + a * p + c * d < dw) && (e(r, i, o, u, a, c, N, A, k, x /= M, b /= M, w, v, _),
                _.point(N, A),
        ...
        return function(n) {
            ...
            function o(r, i) {
                var o = ph([r, i])
                  , u = t(r, i);
                e(y, g, _, m, x, b, y = u[0], g = u[1], _ = r, m = o[0], x = o[1], b = o[2], pw, n),
                n.point(y, g)
            }
            function u() {
                w.point = r,
    ...
    function Kp(t) {
        ...
        n.clipExtent = function(t) {
            return arguments.length ? (N = null == t ? (S = l = h = p = null ,
            _p) : ip(S = +t[0][0], l = +t[0][1], h = +t[1][0], p = +t[1][1]),
            o()) : null == S ? null : [[S, l], [h, p]]
        }
        ,
        n.scale = function(t) {
        ...
        ,
        n.precision = function(t) {
            return arguments.length ? (E = Zp(r, A = t * t),
            o()) : xb(A)
        }
        ,
        n.fitExtent = $p(n),
    ...
    function od() {
        ...
        var n, e, r, i, o, u, a = rd(), c = ed().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]), s = ed().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), f = {
            point: function(t, n) {
                u = [t, n]
            }
        };
    ...
    P.prototype = q.prototype = {
        ...
        clear: function() {
            for (var t in this)
                t[0] === Od && delete this[t]
        },
        keys: function() {
            var t = [];
            for (var n in this)
                n[0] === Od && t.push(n.slice(1));
            return t
        },
        values: function() {
            var t = [];
            for (var n in this)
                n[0] === Od && t.push(this[n]);
            return t
        },
        entries: function() {
            var t = [];
        ...
        each: function(t) {
            for (var n in this)
                n[0] === Od && t(this[n], n.slice(1), this)
        }
    };
    var Fd = q.prototype;
    ...
    Mt.prototype = Tt.prototype = {
        ...
        arc: function(t, n, e, r, i, o) {
            ...
            null === this._x1 ? this._.push("M", c, ",", s) : (Math.abs(this._x1 - c) > dv || Math.abs(this._y1 - s) > dv) && this._.push("L", c, ",", s),
            e && (l > vv ? this._.push("A", e, ",", e, ",0,1,", f, ",", t - u, ",", n - a, "A", e, ",", e, ",0,1,", f, ",", this._x1 = c, ",", this._y1 = s) : (l < 0 && (l = l % pv + pv),
            this._.push("A", e, ",", e, ",0,", +(l >= hv), ",", f, ",", this._x1 = t + e * Math.cos(i), ",", this._y1 = n + e * Math.sin(i))))
        },
    ...
    ge(Se, ke, me(xe, {
        brighter: function(t) {
            return t = null == t ? Qv : Math.pow(Qv, t),
            new Se(this.r * t,this.g * t,this.b * t,this.opacity)
        },
        darker: function(t) {
            return t = null == t ? Jv : Math.pow(Jv, t),
            new Se(this.r * t,this.g * t,this.b * t,this.opacity)
        },
        rgb: function() {
            return this
    ...
    ge(Le, qe, me(xe, {
        ...
        rgb: function() {
            ...
            n = l_ * Ue(n),
            e = p_ * Ue(e),
            new Se(De(3.2404542 * n - 1.5371385 * t - .4985314 * e),De(-.969266 * n + 1.8760108 * t + .041556 * e),De(.0556434 * n - .2040259 * t + 1.0572252 * e),this.opacity)
        }
    })),
    ge(Ye, Ie, me(xe, {
        brighter: function(t) {
    ...
    Ir.prototype = Yr.prototype = {
        ...
        restart: function(t, n, e) {
            ...
            this._next || J_ === this || (J_ ? J_._next = this : G_ = this,
            J_ = this),
            this._call = t,
            this._time = e,
            Vr()
    ...
    , xb = Math.sqrt, bb = Math.tan, wb = {
        ...
        polygonEnd: function() {
            ...
            Ab.lineEnd = wh,
            Tb < 0 ? (Ex = -(zx = 180),
            Cx = -(Px = 90)) : Nb > eb ? Px = 90 : Nb < -eb && (Cx = -90),
            Ox[0] = Ex,
            Ox[1] = zx
        }
    }, Eb = {
    ...
    var Cb, zb, Pb, qb, Lb, Rb, Ub, Db, Ob, Fb, Ib, Yb = 1e9, Bb = -Yb, jb = Gl(), Hb = {
        ...
        result: function() {
            ...
            return nw = ew = rw = iw = ow = uw = aw = cw = sw = 0,
            t
        }
